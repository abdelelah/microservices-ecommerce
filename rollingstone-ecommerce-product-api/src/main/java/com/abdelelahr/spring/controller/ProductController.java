package com.abdelelahr.spring.controller;
...
import com.abdelelahr.spring.service.ProductService;
...
public class ProductController {
   ...
   public ResponseEntity<Product> get(@PathVariable("id") long id) {
	   Optional<Product> returnProduct = productService.get(id);
	   Product product = returnProduct.get();
   ...
   public @ResponseBody Page<Product> getProductPage(
      ...
      Page<Product> pageProducts = productService.getProductsByPage(pageNumber, pageSize);
      return pageProducts;
   }
